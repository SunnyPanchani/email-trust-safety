...
#         return {"risk_level": "high", "reason": "invalid_email"}
...
#         # CRITICAL: Obvious scam indicators (auto-phishing)
...
#                 "description": f"{spam_keyword_count} spam keywords - likely scam"
#             })
#         elif spam_keyword_count >= 5:
#             risk_score += 25
#             risk_factors.append({
#                 "type": "high_spam_keywords",
#                 "weight": "high",
#                 "value": spam_keyword_count,
#                 "description": f"{spam_keyword_count} spam keywords detected"
#             })
...
#                 "weight": "high",
#                 "value": domain_analysis["domain"],
#                 "description": f"Suspicious domain patterns detected"
#             })
...
#         if money_symbols >= 3 or large_amounts >= 2:
#             risk_score += 20
#             risk_factors.append({
#                 "type": "financial_lure",
#                 "weight": "high",
#                 "value": {"symbols": money_symbols, "large_amounts": large_amounts},
#                 "description": "Multiple financial indicators"
#             })
...
#         if md.get("subject_uppercase_ratio", 0) > 0.4 or md.get("spam_exclamation_count", 0) >= 5:
#             risk_score += 10
#             risk_factors.append({
#                 "type": "excessive_formatting",
#                 "weight": "medium",
#                 "description": "Excessive uppercase or exclamation marks"
#             })
...
#                 "type": "unknown_sender",
#                 "weight": "medium",
#                 "description": "First-time sender with suspicious content"
#             })
        
#         # IP in URL or suspicious TLD
...
#         if risk_score >= 60:
#             # Obvious scam - override model
#             label = "phishing"
#             confidence = min(0.95, phish + (risk_score / 100))
#             explanation = f"🚨 CRITICAL THREAT DETECTED (Risk Score: {risk_score}/100) - " + \
#                          ", ".join([f["description"] for f in reasons[:3]])
        
#         elif risk_score >= 35:
#             # High risk - likely phishing
#             label = "phishing" if phish > spam else "spam"
#             confidence = max(phish, spam) + (risk_score / 200)
#             explanation = f"⚠️ HIGH RISK DETECTED (Risk Score: {risk_score}/100) - " + \
#                          ", ".join([f["description"] for f in reasons[:3]])
        
#         elif phish > 0.15 and len(reasons) >= 2:
#             # Moderate risk with phishing indicators
#             label = "phishing"
#             confidence = phish
#             explanation = f"Classified as phishing due to: " + \
#                          ", ".join([f["description"] for f in reasons[:3]])
        
#         elif spam > 0.25 and len(reasons) >= 2:
#             # Moderate risk with spam indicators
#             label = "spam"
#             confidence = spam
#             explanation = f"Classified as spam due to: " + \
#                          ", ".join([f["description"] for f in reasons[:3]])
        
#         else:
#             # Use model prediction
#             confidence = max(ham, spam, phish)
#             if phish == confidence:
#                 label = "phishing"
#             elif spam == confidence:
#                 label = "spam"
#             else:
#                 label = "ham"
            
#             explanation = None if label == "ham" else \
#                          f"Model-based classification with {len(reasons)} risk factors"
